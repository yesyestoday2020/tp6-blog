...
class KeChengBiao extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        // 定义数据表名称
        $table = $this->table('ke_cheng_biao');

        // 添加当前表字段
        $table
            ->addColumn('xueqi_id','integer',['limit'=>11,'default'=>0,'null'=>false,'comment'=>'学期ID'])
            ->addColumn('banji_id','integer',['limit'=>11,'null'=>true,'comment'=>'班级ID'])
