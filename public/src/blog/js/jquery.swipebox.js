...
(function (window, document, $, undefined) {
    ...
    $.swipebox = function (elem, options) {
        ...
        plugin = this,
          ...
          html = '<div id="swipebox-overlay"><div id="swipebox-container"><div id="swipebox-slider"></div>\n\
  <div id="swipebox-top-bar" class="visible-bars"><div id="swipebox-title"></div>\</div><div id="swipebox-bottom-bar">\n\
<div id="swipebox-arrows"><a id="swipebox-prev"></a><a id="swipebox-next"></a></div></div><a id="swipebox-close"></a></div></div>';
